...
namespace Lemmings {
    ...
    void GameUI::init()
    {
        ...
        float textY = Engine::Core::DESIGNED_RESOLUTION_HEIGHT - Button::BUTTON_HEIGHT - JOB_NAME_TEXTURE_HEIGHT - 2.0f;
        ...
        createButton<NumberButton>(UI::ReleaseRateDecrease, this->levelData_->releaseRate, true, heldTimer, sf::Keyboard::F1);
        createButton<NumberButton>(UI::ReleaseRateIncrease, this->levelData_->releaseRate, true, heldTimer, sf::Keyboard::F2);
        createButton<JobButton>(UI::Climber, this->levelData_->climbers, false, Job::Climber, 0.0f, sf::Keyboard::F3);
        createButton<JobButton>(UI::Floater, this->levelData_->floaters, false, Job::Floater, 0.0f, sf::Keyboard::F4);
        createButton<JobButton>(UI::Bomber, this->levelData_->bombers, false, Job::Bomber, 0.0f, sf::Keyboard::F5);
        createButton<JobButton>(UI::Blocker, this->levelData_->blockers, false, Job::Blocker, 0.0f, sf::Keyboard::F6);
        createButton<JobButton>(UI::Builder, this->levelData_->builders, false, Job::Builder, 0.0f, sf::Keyboard::F7);
        createButton<JobButton>(UI::Basher, this->levelData_->bashers, false, Job::Basher, 0.0f, sf::Keyboard::F8);
        createButton<JobButton>(UI::Miner, this->levelData_->miners, false, Job::Miner, 0.0f, sf::Keyboard::F9);
        createButton<JobButton>(UI::Digger, this->levelData_->diggers, false, Job::Digger, 0.0f, sf::Keyboard::F10);
        createButton<Button>(UI::Pause, false, 0.0f, sf::Keyboard::F11); // pause
        createButton<Button>(UI::Nuke, false, 0.0f, sf::Keyboard::F12); // explode
    ...
    void GameUI::jobButtonClicked(UI::UIButtonType index)
    {
        ...
        this->currentJobButton_ = dynamic_cast<JobButton*>(this->buttons_[index].get());
